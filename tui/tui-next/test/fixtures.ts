...
export const fixtureModel = (): OperationsModel => ({
  epics: [{kind: "epic", id: "po-road", title: "Formula graph migration", state: "in_progress", updatedAt: "2026-07-12T00:00:00Z", dependencies: [{id: "po-platform", type: "blocks"}], children: [
    {kind: "issue", id: "po-child", epicId: "po-road", title: "Replace verdict channel safely", state: "in_progress", updatedAt: "2026-07-12T01:00:00Z", dependencies: [], artifacts: [{name: "gate.txt", kind: "txt", path: "/tmp/po-child/gate.txt"}], sessions: [{id: "po-po-child-builder", role: "builder", target: "po-po-child-builder", available: true}], comments: [], attempts: [{id: "12345678-flow", issueId: "po-child", epicId: "po-road", formula: "software-dev-agentic", state: "RUNNING", startedAt: "2026-07-12T01:00:00Z", runtime: {model: "gpt-5.4", effort: "xhigh"}, roles: [{id: "role-1", role: "builder", state: "RUNNING", iteration: 1}]}]},
